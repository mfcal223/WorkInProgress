...
/*   Updated: 2025/04/18 15:45:14 by mpiantan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * is_directory() = check if the given path is a directory.
 * Opens the file in read-only mode and attempts to read a byte.
 * If read fails with errno set to EISDIR, if it's a directory, return 1.
 * If open fails, return -1.
 * Otherwise, return 0 (not a directory).
 */
