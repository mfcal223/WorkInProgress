...
/*   Updated: 2025/03/31 16:48:17 by mcalciat         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*-----------BUILTINS---------------------------------*/
//void	builtin_echo(int ac, char **av);		//echo command (argumentos estan mal - falta update)
...
int		print_export_list(t_env *env);				//for export() -prints message
//builtins (***IN PROCESS***)
